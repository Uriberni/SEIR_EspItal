function [Error,Nous_agru,Inf,Nous_agru2,peak_day,a,sinj1,S,Nous_set]=italgrip1718_S(llindar1,llindar2,llindar3,S_inj)
italia1718_matriu;
%N=10^5;
deltat=1;
tfin=length(Inf)*7;
...
[~,pos]=max(Inf);
peak_day=7*pos;
I(1)=1.91036824948715;
E(1)=2.03171649116133;
...
Sinj3=S_inj(3);
Sinj4=S_inj(4);
    if Nous_agru(i-1)<[0.0400000000000000*Imax]
        alpha=0.000102266042282028;   
    elseif Nous_agru(i-1)>[0.0400000000000000*Imax] && Nous_agru(i-1)<[0.866531998587007*Imax]
        alpha=0.000141968526274661;   
    elseif Nous_agru(i-1)>0.866531998587007*Imax
