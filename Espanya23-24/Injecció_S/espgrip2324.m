function [Error,Nous_agru,Inf,difnous,Nous_agru2,Imax,I1,I2,IMAX,Nous_set,N]=espgrip2324(Alpha,llindar1,llindar2,Iini,Eini,Sini)
espanya;
...
sumrel=0;
for k=1:pos
    sumrel = sumrel + (abs(Nous_set(k)-Inf(k)))/abs(Inf(k));
end
Errel=(sumrel/pos)*100;
%}
