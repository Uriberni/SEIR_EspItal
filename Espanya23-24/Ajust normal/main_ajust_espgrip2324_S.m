...
x0=[0.9,0.65,0.2,20,20,20,40];
%x0=[0.99,0.75,0.45,100,290,160,0];
fun = @(x)espgrip2324_S(x(1),x(2),x(3),x(4:7));
...
disp(x);
disp(Error);
[Error,Nous_agru,Inf,Nous_agru2,peak_day,a,sinj1,S,Nous_set]=espgrip2324_S(x(1),x(2),x(3),x(4:7));

espgrip_2324_S(x(1),x(2),x(3),x(4:7));
%%
...
title('Recta de regressió Espanya 23-24')
