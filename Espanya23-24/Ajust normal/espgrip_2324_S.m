function []=espgrip_2324_S(llindar1,llindar2,llindar3,S_inj)
espanya;
...
[~,pos]=max(Inf);
peak_day=7*pos;
I(1)=1.63799619498647;
E(1)=1.64439875346181;
...
Sinj3=S_inj(3);
Sinj4=S_inj(4);
    if Nous_agru(i-1)<[0.00511378013003489*Imax]
        alpha=0.000140554616771761;   
    elseif Nous_agru(i-1)>[0.00511378013003489*Imax] && Nous_agru(i-1)<[0.206641547003226*Imax]
        alpha=0.000172634960629233;   
    elseif Nous_agru(i-1)>0.206641547003226*Imax
        alpha=0.000294935444065156;
    end
    alpha1(i)=alpha;
...
title('experimentals vs Model Espanya(23-24)');
hold off
yyaxis left
