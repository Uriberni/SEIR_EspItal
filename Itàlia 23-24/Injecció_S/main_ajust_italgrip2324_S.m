...
x0=[0.9,0.65,0.2,50,50,50,10];
%x0=[0.99,0.75,0.45,100,290,160,0];
fun = @(x)italgrip2324_S(x(1),x(2),x(3),x(4:7));

% limits inferiors variables
llindarslb=[0.65,0.6,0.1];
Sinjlb=[0,0,0,0];
...
disp(x);
disp(Error);
[Error,Nous_agru,Inf,Nous_agru2,peak_day,a,sinj1,S,Nous_set]=italgrip2324_S(x(1),x(2),x(3),x(4:7));

italgrip_2324_S(x(1),x(2),x(3),x(4:7));
%%
...
title('Recta de regressió Itàlia 23-24')
